...
For architecture information please refer to [the architecture documentation](/doc/CBSA_Architecture_guide.md)

For details about the Customer Service interface please refer to [the user guide](/etc/usage/sprintBoot/doc/CBSA_Customer_Services_Interface_User_Guide.md)
