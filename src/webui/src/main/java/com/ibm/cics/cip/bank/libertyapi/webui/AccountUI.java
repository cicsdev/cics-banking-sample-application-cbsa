...
public class AccountUI extends VerticalLayout
{
	 ...
	 * only createAccUI is commented fully, editAccUI is commented where it
	 * differs from createCustUI
	 **/
	...
	{
		// Checks customer number, sort code, type, interest, overdraft and
		// balance fields are populated
