...
public class HBankDataAccess
{
	...
	protected void openConnection()
	{
		...
		if (this.conn == null)
		{
			...
			logger.log(Level.FINE,
					() -> "Attempting to create DB2CONN for task number " + taskNumberInteger.toString());
			// Attempt to open a connection
			openConnectionInternal();
			logger.log(Level.FINE,
					() -> "Creation succcessful for DB2CONN for task number " + taskNumberInteger.toString());
		}
		else
		{
	...
	public void closeConnection()
	{
		...
		if (this.conn != null)
		{
			...
			{
				logger.severe("SQLException in com.ibm.cics.cip.bankliberty.web.db2.Customer " + e.getErrorCode() + ","
